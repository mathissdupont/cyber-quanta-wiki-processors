...
export function MethodologyPage() {
  return (
    <article className="wiki-article">
      ...
      <section id="validation"><h2>Otomatik doğrulama</h2><p>Her JSON kayıt uygulama başlarken Zod şemasından geçirilir. Geçersiz URL, eksik kaynak, bilinmeyen durum değeri veya zorunlu alan eksikliği build/test sırasında görünür hata üretir. Uygulama etiketleri, fiyatlar ve benchmarklar da kendi kayıtlarındaki kaynak kimliklerine bağlanmak zorundadır.</p></section>
      <section id="limitations"><h2>Mevcut sınırlamalar</h2><ul><li>Katalog henüz kapsamlı değildir.</li><li>Linux MPU kapsamı üç tam OPN ile başlamıştır; bütün aileleri temsil etmez.</li><li>Fiyat anlık görüntüleri toplam BOM, stok garantisi veya satın alma teklifi değildir.</li><li>Bazı güvenlik ayrıntıları üretici erişimi veya NDA gerektirebilir.</li><li>Kaynak kontrol tarihi güncellik garantisi değildir; periyodik tekrar inceleme gerekir.</li></ul></section>
